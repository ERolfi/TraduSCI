...
class MsgData {
 ...
 //   List<StringItem> *getStringList() const { return _phrases; }
    ...
    unsigned short currentString(unsigned short doesit) { _stringIndex = doesit; }
    bool hasComments() { return _hasComments; }
    bool hasComments(bool doesit) { _hasComments = doesit; }
    unsigned char tradusciFormat() { return _tradusciFormat; }
    unsigned char tradusciFormat(unsigned char version) { _tradusciFormat = version; }
    unsigned char fontSize() { return _fontSize; }
    unsigned char fontSize(unsigned char points) { _fontSize = points; }
