...
int WINAPI WinMain(HINSTANCE hThisInstance, HINSTANCE hPrevInstance, LPSTR lpszArgument, int nFunsterStil)
{
  ...
  */
    ...
    lvc.mask = LVCF_FMT | LVCF_WIDTH | LVCF_TEXT | LVCF_SUBITEM; 
        ...
        lvc.pszText = INTERFACE_MESSAGE;	
        ListView_InsertColumn(hwndListV, 7, &lvc); 
        
        lvc.pszText = INTERFACE_MTRANSLATION;	
        ListView_InsertColumn(hwndListV, 8, &lvc); 
        
        lvc.pszText = INTERFACE_COMMENT;	
           ...
           case WM_COMMAND:
                ...
                switch(LOWORD(wParam))    //CHECK must be checked if HIword is 0??
                {
                 ...
                 case IDM_FILEOPENVOL:
                 {
                    ...
                    if (ExtractFromVolume(hwnd, NULL, 0x8F, "msg", exFile))
